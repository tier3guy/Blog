...
description: "Understand the five key creational design patterns — Singleton, Factory Method, Abstract Factory, Builder, and Prototype — using real-world coding scenarios."
date: "2025-07-01"
tags:
  [
    "Design Patterns",
...
You could use `if`/`else` blocks everywhere — or you could let the **Factory Method Pattern** handle object creation.
